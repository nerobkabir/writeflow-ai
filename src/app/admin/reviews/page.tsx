    ...
    <div className="space-y-6 pb-10">
      <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-foreground text-background px-4 py-2.5 text-sm font-semibold hover:bg-foreground/90 disabled:opacity-50 transition-all duration-200 shadow-sm"
        >
          {summarizing ? (
            <>
